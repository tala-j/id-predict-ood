...
class Trainer:
    def __init__(self, save_csv: str, sweep: bool, train_data, indist_test_data, ood_test_data):
...
def main(project: str, entity: str, sweep: bool,
    ...
    if sweep:
        train_fn = lambda: Trainer(save_csv=SAVE_CSV, sweep=sweep,
        ...
        Trainer(save_csv=SAVE_CSV, sweep=sweep,
                train_data=train_data, indist_test_data=indist_data, ood_test_data=ood_data).train_model()
...
if __name__ == "__main__":
    ...
    main(sweep=args.sweep, project=PROJECT_NAME, entity="trdy", sweep_id=args.sweep_id)
